...
- Generated: 2026-06-02T01:36:32.895903+00:00
...
- Started WNBA-first fundamental model input lane: 3,305 replay rows enriched, 364,756 play-by-play rows available.
- Started timestamped WNBA market-intelligence snapshots: 22 observed rows from 4 source pages.
- Materialized dashboard replay bundle: 57,284 replay lines (3,159 decision replays, 54,125 plot-only price series, 842 PBP-only game-state lines).
...
- Telonex downloaded quote/depth/trade rows: 2,258,881 / 2,664,107,086 / 54,385.
...
- WNBA fundamental inputs: 3,305 replay rows, 2,265 Elo-context rows, 364,756 play-by-play rows.
...
- Replay bundle: 57,284 replay lines, 21,884,802 CLOB points, 842 PBP-only game-state lines, 2,316 replay lines with Odds API overlays.
